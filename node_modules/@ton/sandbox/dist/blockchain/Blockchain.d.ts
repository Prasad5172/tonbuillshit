...
import { Executor, TickOrTock } from "@ton/sandbox/dist/executor/Executor";
import { BlockchainStorage } from "@ton/sandbox/dist/blockchain/BlockchainStorage";
import { Event } from "@ton/sandbox/dist/event/Event";
import { SandboxContractProvider } from "@ton/sandbox/dist/blockchain/BlockchainContractProvider";
import { TreasuryContract } from "@ton/sandbox/dist/treasury/Treasury";
import { GetMethodParams, LogsVerbosity, MessageParams, SmartContract, SmartContractSnapshot, Verbosity } from "@ton/sandbox/dist/blockchain/SmartContract";
import { AsyncLock } from "@ton/sandbox/dist/utils/AsyncLock";
...
export declare class Blockchain {
    ...
    runGetMethod(address: Address, method: number | string, stack?: TupleItem[], params?: GetMethodParams): Promise<import("@ton/sandbox/dist/blockchain/SmartContract").GetMethodResult>;
